...
const SYSTEM_ROLES = [
    { name: 'super_admin', displayName: 'Super Admin', description: 'Full system access', scope: 'GLOBAL', hierarchy: 100, isSystem: true },
    { name: 'admin', displayName: 'Admin', description: 'Administrative access', scope: 'GLOBAL', hierarchy: 80, isSystem: true },
    { name: 'staff', displayName: 'Staff', description: 'Staff member access', scope: 'DOMAIN', hierarchy: 50, isSystem: true },
    { name: 'customer', displayName: 'Customer', description: 'Customer access', scope: 'CUSTOM', hierarchy: 10, isSystem: true },
];
async function main() {
...
`.trim();
    ...
    const socialPlatforms = [
        { platform: 'FACEBOOK', title: 'Facebook', url: '#', displayOrder: 1 },
        { platform: 'INSTAGRAM', title: 'Instagram', url: '#', displayOrder: 2 },
        { platform: 'YOUTUBE', title: 'YouTube', url: '#', displayOrder: 3 },
        { platform: 'PINTEREST', title: 'Pinterest', url: '#', displayOrder: 4 },
        { platform: 'TWITTER', title: 'Twitter', url: '#', displayOrder: 5 },
        { platform: 'WHATSAPP', title: 'WhatsApp', url: '#', displayOrder: 6 },
    ];
    ...
    const featureToggles = [
        { key: 'wishlist', name: 'Wishlist', description: 'Allow customers to save products to wishlist', category: 'CUSTOMER', enabled: true },
        { key: 'cart', name: 'Shopping Cart', description: 'Enable shopping cart functionality', category: 'CHECKOUT', enabled: true },
        { key: 'guest_cart', name: 'Guest Cart', description: 'Allow guest users to add items to cart', category: 'CHECKOUT', enabled: true },
        { key: 'checkout', name: 'Checkout', description: 'Enable checkout process', category: 'CHECKOUT', enabled: true },
        { key: 'coupon', name: 'Coupon Codes', description: 'Allow coupon code usage at checkout', category: 'CHECKOUT', enabled: true },
        { key: 'wallet', name: 'Wallet', description: 'Enable customer wallet feature', category: 'CUSTOMER', enabled: true },
        { key: 'returns', name: 'Returns', description: 'Allow customers to request returns', category: 'CUSTOMER', enabled: true },
        { key: 'refunds', name: 'Refunds', description: 'Enable refund processing', category: 'CUSTOMER', enabled: true },
        { key: 'reviews', name: 'Reviews', description: 'Allow customers to write product reviews', category: 'PRODUCT', enabled: true },
        { key: 'ratings', name: 'Ratings', description: 'Allow customers to rate products', category: 'PRODUCT', enabled: true },
        { key: 'notifications', name: 'Notifications', description: 'Enable in-app notifications', category: 'CUSTOMER', enabled: true },
        { key: 'support', name: 'Support Tickets', description: 'Enable customer support ticket system', category: 'CUSTOMER', enabled: true },
        { key: 'ai_chat', name: 'AI Chat Assistant', description: 'Enable AI-powered chat assistant', category: 'AI', enabled: true },
        { key: 'search', name: 'Search', description: 'Enable product search', category: 'SEARCH', enabled: true },
        { key: 'search_suggestions', name: 'Search Suggestions', description: 'Show autocomplete suggestions in search', category: 'SEARCH', enabled: true },
        { key: 'product_share', name: 'Product Share', description: 'Allow sharing product links', category: 'PRODUCT', enabled: true },
        { key: 'quick_view', name: 'Quick View', description: 'Enable quick product view modal', category: 'PRODUCT', enabled: true },
        { key: 'related_products', name: 'Related Products', description: 'Show related products on product page', category: 'PRODUCT', enabled: true },
        { key: 'newsletter', name: 'Newsletter', description: 'Enable newsletter subscription', category: 'MARKETING', enabled: true },
        { key: 'social_feed', name: 'Social Feed', description: 'Display social media feed on homepage', category: 'SOCIAL', enabled: true },
        { key: 'loyalty', name: 'Loyalty Points', description: 'Show loyalty points on customer side when enabled by super admin', category: 'CUSTOMER', enabled: false },
        { key: 'referral', name: 'Referral Program', description: 'Show referral program on customer side when enabled by super admin', category: 'MARKETING', enabled: false },
        { key: 'gift_cards', name: 'Gift Cards', description: 'Enable gift card purchase and redeem', category: 'CUSTOMER', enabled: true },
        { key: 'recently_viewed', name: 'Recently Viewed', description: 'Track and show recently viewed products', category: 'PRODUCT', enabled: true },
        { key: 'otp_login', name: 'OTP Login', description: 'Allow customers to login with phone OTP', category: 'CUSTOMER', enabled: true },
    ];
    ...
    async function upsertGroup(name, slug, order) {
    ...
    async function upsertAttribute(groupId, name, slug, type, opts = {}) {
