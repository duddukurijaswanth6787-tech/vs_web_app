...
exports.default = (0, config_1.registerAs)('app', () => ({
    ...
    jwt: {
        ...
        rememberMeExpiresIn: parseInt(process.env.JWT_REMEMBER_ME_EXPIRES_IN || '2592000', 10),
    ...
    monitoring: {
        ...
        slowRequestThreshold: parseInt(process.env.MONITORING_SLOW_REQUEST_THRESHOLD || '1000', 10),
    },
    features: {
    ...
    httpLog: {
        ...
        requestBody: process.env.HTTP_LOG_REQUEST_BODY === 'true' ||
            (process.env.HTTP_LOG_REQUEST_BODY !== 'false' &&
                (process.env.NODE_ENV || 'development') !== 'production'),
        responseBody: process.env.HTTP_LOG_RESPONSE_BODY === 'true' ||
            (process.env.HTTP_LOG_RESPONSE_BODY !== 'false' &&
                (process.env.NODE_ENV || 'development') !== 'production'),
        maxBodyLength: parseInt(process.env.HTTP_LOG_MAX_BODY_LENGTH || '10000', 10),
        healthRequests: process.env.HTTP_LOG_HEALTH_REQUESTS === 'true',
        successRequests: process.env.HTTP_LOG_SUCCESS === 'true' ||
    ...
    rag: {
        ...
        requestTimeoutMs: parseInt(process.env.RAG_REQUEST_TIMEOUT_MS || '30000', 10),
    },
    gemini: {
