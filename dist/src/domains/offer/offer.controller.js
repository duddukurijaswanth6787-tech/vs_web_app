...
let OfferController = class OfferController {
    ...
    async findAll(query) {
        return response_builder_1.ResponseBuilder.success(await this.offerService.findAll(query));
    }
    async getActiveOffers() {
        return response_builder_1.ResponseBuilder.success(await this.offerService.getActiveOffers());
    }
    async findById(id) {
        return response_builder_1.ResponseBuilder.success(await this.offerService.findById(id));
    }
    async create(dto, user) {
        return response_builder_1.ResponseBuilder.success(await this.offerService.create(user.sub, dto), 'Offer created');
    }
    async update(id, dto, user) {
        return response_builder_1.ResponseBuilder.success(await this.offerService.update(id, dto, user.sub), 'Offer updated');
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'List offers with filtering and pagination' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [offer_types_1.OfferQueryDto]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OfferController.prototype, "getActiveOffers", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [offer_types_1.CreateOfferDto, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, offer_types_1.UpdateOfferDto, Object]),
    __metadata("design:returntype", Promise)
