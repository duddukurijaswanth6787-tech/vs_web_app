...
let JwtService = class JwtService {
    ...
    secret;
    issuer;
    constructor(configService, sessionSettingsService) {
        ...
        this.secret = secret;
        this.issuer = this.configService.get('app.jwt.issuer', 'vasanthi-designers');
    }
    async sign(payload, rememberMe = false) {
    ...
    async getExpiresIn(rememberMe = false) {
