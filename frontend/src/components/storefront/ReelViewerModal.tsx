          ...
          <div className="relative w-full flex-1 bg-neutral-950 overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute right-3 bottom-12 lg:bottom-16 z-30 flex flex-col items-center gap-4.5 text-white">
              <div className="relative cursor-pointer">
                <div className="w-9 h-9 rounded-full border-2 border-white overflow-hidden bg-[var(--brand-primary)] text-amber-300 font-serif font-bold text-xs flex items-center justify-center shadow-md">
                  VD
                </div>
            ...
            <div className="absolute left-3 bottom-6 lg:bottom-8 z-30 max-w-[68%] text-white space-y-1 drop-shadow-md">
              <div className="flex items-center gap-2">
                <div className="w-5.5 h-5.5 rounded-full bg-[var(--brand-primary)] text-amber-300 font-serif font-bold text-[9px] flex items-center justify-center border border-white/40 shadow-xs">
                  VD
                </div>
        ...
        <div className="hidden lg:flex flex-1 bg-white p-6 flex-col justify-between overflow-y-auto border-l border-neutral-100">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-neutral-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[var(--brand-primary)] text-amber-300 font-serif font-bold text-sm flex items-center justify-center shadow-xs">
                  VD
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <button className="bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-dark)] text-white text-xs font-bold px-4 py-1.5 rounded-full transition-colors shadow-2xs">
                  Follow
                </button>
                <button
                  onClick={onClose}
            ...
            <div className="space-y-2 bg-neutral-50 p-3.5 rounded-2xl border border-neutral-100">
              ...
              <div className="flex items-center gap-1.5 text-xs text-[var(--brand-primary)] font-semibold">
