    ...
    <MobilePageContainer>
      ...
      <main className="flex-1 max-w-[1360px] mx-auto w-full px-3.5 sm:px-6 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div>
            <h1 className="text-xl sm:text-3xl font-bold font-serif text-[#800020] tracking-tight">
        ...
        <div className="grid grid-cols-3 gap-2 bg-rose-50/60 border border-rose-100/80 rounded-2xl p-2.5 text-center text-[10px] font-semibold text-neutral-700 shadow-2xs">
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            <div>
              <p className="font-bold text-[#800020]">Secure Checkout</p>
          ...
          <div className="flex flex-col items-center justify-center gap-1 border-x border-rose-200/50 px-1">
            ...
            <div>
              <p className="font-bold text-[#800020]">Easy Returns</p>
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            <div>
              <p className="font-bold text-[#800020]">COD Available</p>
        ...
        {isLoading && (
          <div className="bg-white border border-neutral-200/80 rounded-2xl p-12 text-center shadow-xs">
            <div className="w-8 h-8 border-3 border-[#800020] border-t-transparent rounded-full animate-spin mx-auto mb-3" />
        ...
        {error && (
          <div className="bg-rose-50 border border-rose-200 rounded-2xl p-4 text-xs text-rose-800 flex items-center justify-between shadow-xs">
            ...
            <button
              onClick={() => refetch()}
              className="bg-[#800020] text-white text-[10px] font-bold px-3 py-1.5 rounded-lg hover:bg-[#600018]"
            >
              Retry
            </button>
          </div>
        ...
        {!isLoading && items.length === 0 && (
          <div className="bg-white border border-neutral-200/80 rounded-3xl p-10 text-center space-y-4 shadow-xs max-w-md mx-auto my-6">
            <div className="w-14 h-14 bg-rose-50 text-[#800020] rounded-full flex items-center justify-center mx-auto">
            ...
            <Link
              href="/"
              className="inline-block bg-[#800020] hover:bg-[#600018] text-white text-xs font-bold uppercase tracking-wider px-6 py-3 rounded-xl transition-all shadow-2xs"
            >
              Start Shopping
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8 items-start">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-3.5 sm:gap-4 items-center">
                          <div className="md:col-span-6 flex gap-3 sm:gap-4 items-start sm:items-center pr-6 md:pr-0">
                            ...
                            <div className="space-y-1 min-w-0 flex-1">
                              <Link
                                ...
                                className="text-xs sm:text-base font-bold text-neutral-900 line-clamp-2 hover:text-[#800020] leading-snug"
                              >
                              ...
                              <div className="text-sm font-bold text-[#800020] pt-0.5 md:hidden">
                              ...
                              <div className="hidden md:flex items-center gap-4 pt-2">
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 text-xs font-semibold text-neutral-500 hover:text-[#800020]"
                                >
                          ...
                          <div className="col-span-1 flex items-center justify-between border-t border-neutral-100 pt-2.5 mt-1 md:hidden">
                            <button
                              type="button"
                              onClick={() => handleSaveForLater(item)}
                              className="inline-flex items-center gap-1.5 text-xs font-semibold text-neutral-600 hover:text-[#800020]"
                            >
                  ...
                  {couponApplied ? (
                    ...
                    <form onSubmit={handleApplyCoupon} className="flex gap-2">
                      ...
                      <button
                        ...
                        className="bg-[#800020] hover:bg-[#600018] text-white text-xs font-bold px-5 py-2.5 rounded-xl transition-all shadow-2xs disabled:opacity-60"
                      >
                ...
                <div className="bg-white border border-neutral-200/80 rounded-2xl p-4 sm:p-5 shadow-2xs space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-neutral-900">
                      {isFreeShipping ? (
                        ...
                        <>
                          You are <strong className="text-[#800020]">{formatInr(amountToFreeShipping)}</strong> away from FREE Shipping!
                        </>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="space-y-1 pl-12">
                    <div className="w-full h-2 bg-neutral-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#800020] to-rose-600 rounded-full transition-all duration-500"
            ...
            <div className="lg:col-span-4 space-y-4">
              <div className="bg-white border border-neutral-200/80 rounded-2xl p-5 sm:p-6 shadow-2xs space-y-4">
                <h3 className="text-base sm:text-lg font-bold font-serif text-[#800020] border-b border-neutral-100 pb-3">
                  Order Summary
                </h3>
                ...
                <div className="bg-rose-50/60 border border-rose-100 rounded-xl p-3.5 flex items-center justify-between">
                  ...
                  <span className="text-xl sm:text-2xl font-bold font-serif text-[#800020]">
                ...
                <button
                  ...
                  className="w-full bg-[#800020] hover:bg-[#600018] text-white text-xs sm:text-sm font-bold tracking-wider uppercase py-3.5 rounded-xl shadow-md transition-all flex items-center justify-center gap-2"
                >
