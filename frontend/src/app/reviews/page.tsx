    ...
    <div className="min-h-screen bg-[var(--page-bg)] flex flex-col font-sans antialiased text-neutral-900">
      ...
      <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex-1 space-y-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold font-serif text-[var(--brand-primary)]">Customer Reviews & Stories</h1>
        ...
        <div className="bg-white border border-sky-100 rounded-3xl p-6 shadow-xs flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <div className="bg-sky-50/60 border border-sky-100 rounded-2xl px-4 py-3 text-center">
              <p className="text-lg font-bold text-[var(--brand-primary)]">98%</p>
              <p className="text-[11px] text-neutral-600 font-medium">Satisfaction Rate</p>
            </div>
            <div className="bg-sky-50/60 border border-sky-100 rounded-2xl px-4 py-3 text-center">
              <p className="text-lg font-bold text-[var(--brand-primary)]">100%</p>
            ...
            <div key={review.id} className="bg-white border border-neutral-200/80 rounded-2xl p-5 space-y-3 shadow-2xs">
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  <div className="w-9 h-9 rounded-full bg-[var(--brand-primary)] text-amber-300 font-serif font-bold text-sm flex items-center justify-center">
                    {review.author[0]}
                  </div>
                  <div>
              ...
              <h3 className="text-sm font-bold text-[var(--brand-primary)]">{review.title}</h3>
