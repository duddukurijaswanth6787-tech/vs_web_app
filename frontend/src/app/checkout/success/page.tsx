  ...
  return (
    <div className="min-h-screen bg-[#FDFBFB] flex flex-col font-sans antialiased text-neutral-900">
      <main className="max-w-md mx-auto w-full px-4 py-16 flex-1 text-center space-y-4">
        ...
        <h1 className="text-2xl font-bold font-serif text-[#800020]">Order Placed</h1>
        {orderNumber && (
        ...
        <div className="flex flex-col gap-2 pt-4">
          {orderNumber && (
            <Link
              ...
              className="bg-[#800020] text-white text-sm font-bold py-3 rounded-xl"
            >
              Track Order
            </Link>
          )}
          ...
          <Link href="/" className="text-xs font-semibold text-[#800020]">
            Continue Shopping
          </Link>
        </div>
      </main>
