    ...
    <div className="min-h-screen bg-[var(--page-bg)] flex flex-col font-sans antialiased text-neutral-900">
      ...
      <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex-1 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold font-serif text-[var(--brand-primary)]">Privacy & Data Settings</h1>
        ...
        <div className="bg-white border border-neutral-200/90 rounded-3xl p-6 shadow-xs space-y-5">
          <div className="flex items-center gap-3 p-4 bg-sky-50/60 border border-sky-100 rounded-2xl">
            <ShieldCheck className="w-8 h-8 text-[var(--brand-primary)] shrink-0" />
            <div>
              <p className="text-sm font-bold text-[var(--brand-primary)]">Your Privacy is Protected</p>
          ...
          <div className="space-y-4 pt-2">
            <div className="border border-neutral-200/80 rounded-2xl p-4 space-y-2">
              <h3 className="text-sm font-bold text-neutral-900 flex items-center gap-2">
                <Lock className="w-4 h-4 text-[var(--brand-primary)]" /> Data Encryption & Security
              </h3>
            ...
            <div className="border border-neutral-200/80 rounded-2xl p-4 space-y-2">
              <h3 className="text-sm font-bold text-neutral-900 flex items-center gap-2">
                <Eye className="w-4 h-4 text-[var(--brand-primary)]" /> Communication Preferences
              </h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="border border-neutral-200/80 rounded-2xl p-4 space-y-2">
              <h3 className="text-sm font-bold text-neutral-900 flex items-center gap-2">
                <FileText className="w-4 h-4 text-[var(--brand-primary)]" /> Full Privacy Policy
              </h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
                For detailed information on data retention, cookies, and your data rights, read our full document below.
              </p>
              <Link href="/privacy" className="inline-block text-xs font-bold text-[var(--brand-primary)] hover:underline pt-1">
