...
export default function InventoryPage() {
  ...
  const columns: Column<InventoryResponse>[] = [
    ...
    { key: 'effective', label: 'Effective', render: (i) => { const eq = i.availableQuantity - i.reservedQuantity; return <span className={`font-bold text-center block ${eq <= 0 ? 'text-red-600' : 'text-neutral-900'}`}>{eq}</span>; }},
