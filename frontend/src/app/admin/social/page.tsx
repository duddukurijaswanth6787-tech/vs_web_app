      ...
      <div className="w-full max-w-5xl rounded-3xl bg-white p-5 sm:p-7 shadow-2xl border border-neutral-200 animate-in fade-in zoom-in-95 duration-200 text-xs max-h-[92vh] flex flex-col justify-between overflow-y-auto">
        ...
        <div className="flex items-center justify-between border-b border-neutral-100 pb-3.5 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-2xl bg-[#0284c7] text-amber-300 flex items-center justify-center font-bold text-lg shadow-sm">
              ❖
            </div>
            <div>
          ...
          <div className="lg:col-span-7 space-y-4 pr-1">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 p-1 bg-neutral-100 rounded-xl border border-neutral-200/60">
                <button
                  ...
                  className={`py-2 px-3 rounded-lg font-bold text-xs flex items-center justify-center gap-2 transition ${contentType === SocialPostContentType.REEL ? 'bg-white text-[#0284c7] shadow-xs' : 'text-neutral-600 hover:text-neutral-900'}`}
                >
            ...
            <div className="space-y-2">
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-neutral-50 border border-neutral-200 rounded-xl p-2.5 text-xs text-neutral-900 focus:outline-hidden focus:ring-2 focus:ring-[#0284c7]/20 resize-none font-sans"
                />
              </div>
            ...
            <div className="space-y-2.5 border-t border-neutral-100 pt-3">
              <div className="flex items-center justify-between">
                <label className="block text-[11px] font-extrabold text-[#0284c7] uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        >
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="text-[10px] font-semibold text-[#0284c7] font-mono">₹{price.toLocaleString('en-IN')}</div>
                            </div>
                          </div>
        ...
        {isSubmitting && uploadProgress !== null && uploadProgress > 0 && (
          <div className="mb-3 space-y-1">
            ...
            <div className="w-full bg-neutral-200 h-2 rounded-full overflow-hidden">
              <div className="bg-[#0284c7] h-full transition-all duration-200" style={{ width: `${uploadProgress}%` }} />
            </div>
          </div>
        )}
        ...
        <div className="flex items-center justify-between pt-3 border-t border-neutral-100 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-[#0284c7] hover:bg-[#0B3B78] text-white font-bold py-2.5 px-5 rounded-xl text-xs transition shadow-md disabled:opacity-50 flex items-center gap-1.5"
            >
