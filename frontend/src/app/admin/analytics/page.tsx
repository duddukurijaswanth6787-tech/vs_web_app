...
export default function AnalyticsPage() {
  ...
  if (omniErr) return <PageError title="Analytics Load Failed" message="Could not fetch live analytics." retry={handleSyncLive} />;
      ...
      <div className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <span className="bg-emerald-50 text-emerald-700 font-bold text-xs px-2.5 py-1 rounded-full border border-emerald-200/60 uppercase tracking-wider flex items-center gap-1">
              <Zap className="w-3 h-3 text-emerald-500 fill-emerald-500" /> Live DB Data Connected
            </span>
          </div>
        ...
        <div className="flex items-center gap-3 self-start md:self-auto flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 rounded-xl transition-all shadow-xs cursor-pointer"
            title="Sync Live DB Analytics"
          >
          ...
          <div className="bg-white rounded-2xl border border-neutral-200 p-6 shadow-xs space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-neutral-500 font-medium">Comparative sales performance timeline</p>
              </div>
