  ...
  return (
    <div className="min-h-screen bg-[var(--page-bg)] flex flex-col font-sans antialiased text-neutral-900 pb-16">
      <header className="sticky top-0 z-50 bg-white border-b border-neutral-100 px-4 py-3 flex items-center gap-3 shadow-xs">
        ...
        <h1 className="text-lg font-bold font-serif text-[var(--brand-primary)]">Press & Media</h1>
      </header>
      ...
      <main className="max-w-4xl mx-auto w-full px-4 py-8 flex-1 space-y-8">
        ...
        <div className="space-y-4">
          <h3 className="text-base font-serif font-bold text-[var(--brand-primary)]">Featured Publications</h3>
              ...
              <div key={idx} className="bg-white border border-neutral-200 rounded-2xl p-5 space-y-3 shadow-xs flex flex-col justify-between hover:border-sky-200 transition-colors">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="font-serif font-bold text-xs text-[var(--brand-primary)] uppercase tracking-wider">{item.publisher}</span>
        ...
        <div className="bg-white border border-neutral-200 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="space-y-1 text-center sm:text-left">
            <h3 className="font-serif font-bold text-base text-[var(--brand-primary)]">Media & PR Inquiries</h3>
          ...
          <a
            ...
            className="bg-[var(--brand-primary)] text-white text-xs font-bold px-6 py-2.5 rounded-xl hover:bg-[var(--brand-primary-dark)] shrink-0 flex items-center gap-2"
          >
