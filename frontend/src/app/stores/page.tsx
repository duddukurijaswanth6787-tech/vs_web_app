  ...
  return (
    <div className="min-h-screen bg-[#FDFBFB] flex flex-col font-sans antialiased text-neutral-900 pb-16">
      <header className="sticky top-0 z-50 bg-white border-b border-neutral-100 px-4 py-3 flex items-center gap-3 shadow-xs">
        ...
        <h1 className="text-lg font-bold font-serif text-[#800020]">Store Locator</h1>
      </header>
          ...
          {STORES.map((store) => (
            <div key={store.id} className="bg-white border border-neutral-200 rounded-3xl p-6 space-y-4 shadow-xs hover:border-rose-200 transition-colors">
              <div className="space-y-1">
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#800020] bg-rose-50 px-2.5 py-0.5 rounded-full">
                  {store.city} Store
                </span>
              ...
              <div className="pt-2 flex items-center gap-3">
                <a
                  ...
                  className="flex-1 bg-[#800020] text-white text-xs font-bold py-2.5 rounded-xl text-center hover:bg-[#600018] flex items-center justify-center gap-1.5"
                >
