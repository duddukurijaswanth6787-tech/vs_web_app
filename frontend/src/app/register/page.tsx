        ...
        <form onSubmit={onSubmit} className="bg-white border border-neutral-200 rounded-3xl p-6 space-y-4 shadow-xs">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <label className="block space-y-1.5">
              ...
              <select
                ...
                className="w-full text-xs border border-neutral-200 rounded-xl px-3 py-3 outline-none focus:border-[var(--brand-primary)] bg-white font-medium text-neutral-800"
              >
          ...
          <div className="flex items-start gap-2.5 pt-1">
            <button
              ...
              className="mt-0.5 text-[var(--brand-primary)] hover:scale-105 transition-transform"
            >
              {form.agreeToTerms ? (
            ...
            <span className="text-xs text-neutral-600 leading-snug">
              ...
              <Link href="/terms" className="text-[var(--brand-primary)] font-semibold underline">
                Terms of Service
              </Link>{' '}
              and{' '}
              <Link href="/privacy" className="text-[var(--brand-primary)] font-semibold underline">
                Privacy Policy
              </Link>
              .
            </span>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-dark)] disabled:opacity-60 text-white text-sm font-bold py-3 rounded-xl transition-all shadow-md mt-2"
          >
