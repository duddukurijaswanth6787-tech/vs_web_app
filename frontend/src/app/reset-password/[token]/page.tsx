  ...
  return (
    <div className="min-h-screen bg-[var(--page-bg)] flex flex-col font-sans antialiased text-neutral-900">
      <header className="sticky top-0 z-50 bg-white border-b border-neutral-100 px-4 py-3 flex items-center justify-between">
        ...
        <h1 className="text-lg font-bold font-serif text-[var(--brand-primary)]">Reset Password</h1>
        <div className="w-6" />
      </header>
        ...
        {checking ? (
          ...
          <div className="bg-white border border-neutral-200 rounded-3xl p-6 text-center space-y-3">
            ...
            <button
              ...
              className="w-full bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-dark)] text-white text-sm font-bold py-3 rounded-xl"
            >
              Go to Login
            </button>
          </div>
          ...
          <div className="bg-white border border-neutral-200 rounded-3xl p-6 text-center space-y-3">
            ...
            <Link
              ...
              className="block w-full bg-[var(--brand-primary)] hover:bg-[var(--brand-primary-dark)] text-white text-sm font-bold py-3 rounded-xl text-center"
            >
              Request a New Link
            </Link>
          </div>
