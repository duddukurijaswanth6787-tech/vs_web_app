...
export class EmailController {
  ...
  @ApiOperation({
    summary:
      'Get transactional email configuration (Amazon SES / SendGrid / SMTP)',
  })
  async getConfig() {
  ...
  @ApiOperation({
    summary:
      'Update transactional email configuration (Amazon SES / SendGrid / SMTP)',
  })
  async updateConfig(
  ...
  @Post('test')
  @ApiOperation({
    summary: 'Send a test email to verify SMTP gateway connection',
  })
  async sendTestEmail(
    @CurrentUser() user: JwtPayload,
